...
def main():
    ...
    r_img = Image.open("../sample/huaxi_captcha/1578555793427654.jpg")

    # r_img = Image.open("../tools/a.png")
    # r_img = Image.open("../gen_captcha/test_img/2410_15789032689758518.jpg")
    # t = R.rec_image(r_img)
    root_dir = "../sample/huaxi_captcha"
    save_dir = "../sample/huaxi1/test"

    for j, i in enumerate(os.listdir(root_dir)):
        # print(i)
        r_img = Image.open(root_dir+ "/"+i)
        t = R.rec_image(r_img)
        r_img.save(f"{save_dir}/{t}_{i}")
        print(t, i, j)
        r_img.show()
